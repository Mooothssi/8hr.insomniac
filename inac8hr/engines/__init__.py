...
class GameEngine:
    ...
    def load_all(self):
        ...
        self.audio.add_source_from_filename("assets/audio/spoilt_ballot.mp3", "AGENTS/BALLOT_SPOILT_COUNTED")
        self.audio.add_source_from_filename("assets/audio/rockHit2.mp3", "PARTICLES/ROCK_HIT")
